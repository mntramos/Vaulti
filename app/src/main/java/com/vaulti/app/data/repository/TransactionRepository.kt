...
class TransactionRepository(
    ...
    fun getCurrentMonthExpense(): Flow<Double> = transactionDao.getCurrentMonthExpense().map { it ?: 0.0 }
    fun getCurrentMonthIncome(): Flow<Double> = transactionDao.getCurrentMonthIncome().map { it ?: 0.0 }
